...
import { MDBCard, MDBCardBody, MDBIcon, MDBRow, MDBCol, MDBCardText, MDBNavLink, MDBAnimation } from 'mdbreact';
              ...
              <Link to="/trxPage" activeClassName="activeClass">
                <MDBCard className="cascading-admin-card">
                  ...
                  <MDBCardBody>
                    ...
                    <MDBCardText>Up from last month (23%)</MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </Link>
            </MDBCol>
              ...
              <Link to="/trxPage" activeClassName="activeClass">
                <MDBCard className="cascading-admin-card">
                  ...
                  <MDBCardBody>
                    ...
                    <MDBCardText>Up from last month (28%)</MDBCardText>
                  </MDBCardBody>
                </MDBCard>
              </Link>
            </MDBCol>
